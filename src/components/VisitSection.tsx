                ...
                <div className="space-y-1.5">
                  {hours.map((h) => (
                    <div key={h.day} className="flex justify-between font-body text-sm max-w-xs">
                      <span className={h.time === "Closed" ? "text-muted-foreground" : "text-foreground"}>
                        {h.day}
                      </span>
                      <span className={h.time === "Closed" ? "text-muted-foreground" : "text-primary font-medium"}>
                        {h.time}
                      </span>
                    </div>
                  ))}
