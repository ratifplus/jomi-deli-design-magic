  ...
  return (
    <section id="about" ref={ref} className="section-padding bg-background">
      <div className="max-w-6xl mx-auto">
        {/* About card — reference style: image right, text left */}
          ...
          <div className={`relative transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
            ...
            <div className="absolute -bottom-6 left-6 flex gap-3">
              <div className="bg-card border border-border rounded-xl px-4 py-3 shadow-lg">
                <div className="text-xl font-display font-bold text-primary">100%</div>
                <div className="text-xs text-muted-foreground font-body">Sourdough</div>
              </div>
              <div className="bg-card border border-border rounded-xl px-4 py-3 shadow-lg">
                <div className="text-xl font-display font-bold text-primary">Fresh</div>
                <div className="text-xs text-muted-foreground font-body">Baked Daily</div>
              </div>
              <div className="bg-card border border-border rounded-xl px-4 py-3 shadow-lg">
                <div className="text-xl font-display font-bold text-primary">Local</div>
                <div className="text-xs text-muted-foreground font-body">Ingredients</div>
              </div>
            </div>
          </div>
        </div>
